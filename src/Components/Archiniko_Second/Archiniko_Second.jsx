...
import './Archiniko_Second.css'

function Archiniko_Second() {
    return (
            ...
            <div className="row">
                <div className="col-md-4 d-block m-auto " >
                    <p className='text-white text-center  d-block m-auto prhaa' data-aos="fade-up"      data-aos-duration="1000">Many non-utility NFTs have no real value other than the value a
                        ...
                        the workers or managers who run these projects
                        and their earnings are paid to the NFT owners as a Passive Income
                        via smart contract.</p>
...
export default Archiniko_Second
